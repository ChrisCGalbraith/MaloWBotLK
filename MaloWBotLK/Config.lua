...
-- Feral
mb_statWeights["Druid"]["Feral Combat"] = {}
mb_statWeights["Druid"]["Feral Combat"].agility = 0.70
mb_statWeights["Druid"]["Feral Combat"].intellect = 0.0
mb_statWeights["Druid"]["Feral Combat"].spirit = 0.0
mb_statWeights["Druid"]["Feral Combat"].strength = 0.1
mb_statWeights["Druid"]["Feral Combat"].stamina = 1.0
mb_statWeights["Druid"]["Feral Combat"].critRating = 0.03
mb_statWeights["Druid"]["Feral Combat"].resilienceRating = 0.0
mb_statWeights["Druid"]["Feral Combat"].defenseRating = 0.1
mb_statWeights["Druid"]["Feral Combat"].expertiseRating = 0.16
mb_statWeights["Druid"]["Feral Combat"].dodgeRating = 0.65
mb_statWeights["Druid"]["Feral Combat"].parryRating = 0.0
mb_statWeights["Druid"]["Feral Combat"].blockRating = 0.0
mb_statWeights["Druid"]["Feral Combat"].armorPenetrationRating = 0.0
mb_statWeights["Druid"]["Feral Combat"].hitRating = 0.08
mb_statWeights["Druid"]["Feral Combat"].hasteRating = 0.05
mb_statWeights["Druid"]["Feral Combat"].attackPower = 0.04
mb_statWeights["Druid"]["Feral Combat"].armor = 0.25
mb_statWeights["Druid"]["Feral Combat"].blockValue = 0.0
mb_statWeights["Druid"]["Feral Combat"].spellPower = 0.66
mb_statWeights["Druid"]["Feral Combat"].mp5 = 0.0
mb_statWeights["Druid"]["Feral Combat"].dps = 0.0
mb_statWeights["Druid"]["Feral Combat"].socketMeta = 100
mb_statWeights["Druid"]["Feral Combat"].socketColored = 16
-- Restoration
